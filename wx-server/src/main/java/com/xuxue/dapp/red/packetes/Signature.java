...
public class Signature {
    ...
    public static String getSign(Map<String,Object> map){
        ...
        String result = sb.toString();
        result += "key=" + Configure.getKey();
        if(result.indexOf("rpackage") >= 0) {
        	result = result.replace("rpackage", "package");
        }
        //Util.log("Sign Before MD5:" + result);
        result = MD5.MD5Encode(result).toUpperCase();
        //Util.log("Sign Result:" + result);
  ...
  */
	...
	public static void sign(SortedMap<String, String> params){
		...
		result.append("key=").append(Configure.getKey());
		//System.out.println("==========================sign1:"+result.toString());
		String sign = MD5.getMD5ofStr(result.toString()).toUpperCase();
	...
	public static void sign4JS(SortedMap<String, String> params){
		Set<Entry<String,String>> entrys=params.entrySet();
		Iterator<Entry<String,String>> it=entrys.iterator();
		StringBuffer result = new StringBuffer();
		while(it.hasNext())
		...
		//result.append("key=").append(Configure.getKey());
		//System.out.println("==========================sign1:"+result.toString());
		String sign = new SHA1().getDigestOfString(result.substring(0, result.length() - 1).toString().getBytes());
		//System.out.println("==========================sign2:"+sign);
	 ...
	 * @param params
	 */
	public static void sign4Kanzhong(SortedMap<String, String> params){
		Set<Entry<String,String>> entrys=params.entrySet();
		Iterator<Entry<String,String>> it=entrys.iterator();
		StringBuffer result = new StringBuffer();
		while(it.hasNext())
